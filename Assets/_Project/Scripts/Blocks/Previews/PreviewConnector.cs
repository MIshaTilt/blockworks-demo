    ...
    public class PreviewConnector : MonoBehaviour
    {
        ...
        public (State state, IEnumerable<SocketPair> socketPairs) CheckForConnection(Chunk chunk)
        {
            ...
            if (valid == false)
            {
                ...
                return (State.NoConnections, new SocketPair[0]);
            }
            ...
            if (closeSocketPairs.Length < 2)
            {
                if (connections != closeSocketPairs.Length)
                {
                    ...
                    return (State.SocketsTooFar, new SocketPair[0]);
                }
            }
            ...
            if (connections < 2)
            {
                ...
                return (State.OneSocketAligned, connectionCandidates);
            }
            else
            {
                return (State.Aligned, connectionCandidates);
            }
        }
